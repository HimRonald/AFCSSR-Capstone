...
const NewsCard: React.FC<NewsCardProps> = ({ id, date, title, description, imageUrl }) => {
    return (
        <Card className="flex flex-col bg-[#027AC6] font-libre shadow-sm transition-all hover:scale-[1.02] hover:shadow-md focus-within:scale-[1.02] focus-within:shadow-md">
            ...
            <CardContent className="p-4 flex flex-col justify-between flex-1">
                ...
                <Link href={`/News&Events/${id}`} className="mt-4 inline-flex items-center justify-end gap-2 text-white">
