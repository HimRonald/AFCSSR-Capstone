    ...
    return (
        <div>
            ...
            <div className="mx-auto container">
                ...
                <div className="grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 mx-auto container mt-[50px] gap-6 px-2">
                ...
                <div className="mx-[160px] mt-[25px] text-justify">
                ...
                <div className="ml-[160px] mt-[50px] text-justify">
                ...
                <div className="m-[160px] mt-[25px] text-justify">
