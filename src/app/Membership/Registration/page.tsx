      ...
      <div className="mx-auto container">
        ...
        <div className="w-[1197px] h-[477px] mx-[100px] mt-[40px]">
          ...
          <div className="mx-auto mt-[25px] flex justify-center">
            <div className="flex flex-col">
              ...
              <input
                type="text"
                className="w-[726px] h-[56px] rounded-xl mt-[7px]"
              />
            </div>
          ...
          <div className="mx-auto mt-[25px] flex justify-center">
            <div className="flex flex-col">
              ...
              <input
                type="text"
                className="w-[1114px] h-[56px] rounded-xl mt-[7px]"
              />
            </div>
          </div>
        </div>
          ...
          <div className="mx-[41px] mt-[25px] flex">
            <div className="flex">
              ...
              {employmentType === "public" && (
                <div className="flex">
                  <div className="flex flex-col ml-[50px]">
                    <label htmlFor="ministry" className="font-semibold">
                  ...
                  <div className="flex flex-col ml-[50px]">
                    <label htmlFor="publicPosition" className="font-semibold">
              ...
              {employmentType === "private" && (
                <div className="flex">
                  ...
                  <div className="flex flex-col ml-[50px]">
                    <label htmlFor="privatePosition" className="font-semibold">
                      Position <span className="text-red-500">*</span>
                    </label>
                    <input
                      type="text"
        ...
        <div className="flex flex-col justify-center mx-[100px] mt-[90px]">
          ...
          {addBusiness.map((panel, index) => (
            <div
              key={index}
              className="w-[1198px] h-[511px] mt-[25px] flex flex-col border-x-2 border-y-2 rounded-xl"
            >
              <button
          ...
          <button
            ...
            id="addBusiness"
            type="button"
            className="w-[1198px] h-[75px] bg-[#027AC6] my-[15px] mx-[21px] flex flex-col justify-center items-center rounded-xl"
          >
              ...
              <div className="ml-[100px]">
                <div className="mt-[70px] mb-[21px]">
                  <span className="">
                    ...
                    <span className="text-[#027AC6] font-semibold">30USD</span>{" "}
        ...
        <button
          type="button"
          className="w-[1198px] h-[75px] bg-[#027AC6] my-[15px] mx-[80px] flex flex-col justify-center items-center rounded-xl"
        >
